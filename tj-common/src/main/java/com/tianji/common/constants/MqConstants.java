...
public interface MqConstants {
    ...
    interface Key {
        ...
        String LIKED_RECORD_KEY_TEMPLATE = "{}.liked.record.changed";
        /*问答*/
        String QA_LIKED_TIMES_KEY = "QA.times.changed";
        String QA_LIKED_RECORD_KEY = "QA.liked.record.changed";
        /*笔记*/
        String NOTE_LIKED_TIMES_KEY = "NOTE.times.changed";
        String NOTE_LIKED_RECORD_KEY = "NOTE.liked.record.changed";
